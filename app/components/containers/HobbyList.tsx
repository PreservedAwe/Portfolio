...
function Hobby({heading, pic_url, pic_alt, description}: HobbyArgs) {
  return(
    <motion.div animate={{ rotate: [-3, 3] }} transition={{ repeat: Infinity, duration: 1, repeatType: "reverse", ease: "linear" }} className="shrink-0 flex flex-col bg-black rounded-lg border-2 border-white size-72 m-3 gap-2 p-3 overflow-x-hidden overflow-y-auto">
